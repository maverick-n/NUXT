		...
		<header>
			...
			<div class="nav">
				<div class="navcontent">
					...
					<ul>
						<li v-for="i in data">
							<a :href="'/channel/'+i.channel.id">{{i.channel.name}}</a>
							</a>
						</li>
					</ul>
				</div>
...
<script>
	...
	export default {
		async asyncData({params}) {
			...
			var backData = await axios.get('http://backup.17getfun.com/discovery/channelContentsPaging?channelId=37&page=1&pageSize=20&tagSize=35');            
			return {
				data: data.data,
