		...
		<header>
			...
			<div class="nav">
				<div class="navcontent">
					...
					<ul>
						<li v-for="i in data">
							<a :id="i.channel.id" :href='"id="+i.channel.id'>{{i.channel.name}}</a>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="contenttext">
								...
								<div class='list-inner'>
									...
									<div class='list-fn'>
										<div class='fl'>
											...
											<span class='heat'>{{i.content.heatCount}}热度</span>
										</div>
				...
				<div class="contenttextright">
					...
					<div class="zuihosttag">
						<strong class="clearfix"><i></i>热门标签<a href="alltag">更多</a></strong>
...
<script>
	...
	export default {
		async asyncData({}) {
			...
			let backData = await axios.get('http://backup.17getfun.com/discovery/channelContentsPaging?channelId=37&page=1&pageSize=30&tagSize=35 ');            
			return {
				data: data.data,
...
<style scoped>
	* {
	...
	.columns-list>li>.list-inner>.list-fn>.fl>span {
		color: #aaa;
	}
